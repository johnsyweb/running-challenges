...
- Tool versions are defined in `mise.toml` (for example, Node.js 20, pnpm 10, and Ruby 3.3).
- On a local machine:
...
- To verify the Jekyll website builds and runs (e.g. after upgrading Ruby), run `./script/server-website`.
